...
def Golden(
    ...
    if dataset_name == "ntuh":
        sheet = pd.read_csv("/home/arlen/deepopg-eval/review/(WIP) NTUH Summary Golden Label - Per-study.csv")
...
def dentist_review(
    ...
    pano_finding_1_df = pd.read_csv("/home/arlen/deepopg-eval/review/Pano Finding - 1 (Responses) - Form Responses 1.csv")
    pano_finding_2_df = pd.read_csv("/home/arlen/deepopg-eval/review/Pano Finding - 2 (Responses) - Form responses 1.csv")
    pano_finding_3_df = pd.read_csv("/home/arlen/deepopg-eval/review/Pano Finding - 3 (Responses) - Form responses 1.csv")
    pano_finding_4_df = pd.read_csv("/home/arlen/deepopg-eval/review/Pano Finding - 4 (Responses) - Form responses 1.csv")
...
def ROC_curve(
    ...
    # filter the ROC curve in the 120 images of dentist reviews
...
for dentist in dentist_name:
    dentist_dataframe = dentist_review(dentist_name=dentist)
...
fpr, tpr, roc_auc = ROC_curve(golden_dataframe, df_result, dentist_dataframe)
